...
def get_base_revision(task, source_env_prefix):
...
def get_base_branch(task, source_env_prefix):
    ...
    """
    return _extract_from_env_in_payload(task, source_env_prefix + "_BASE_BRANCH", _extract_from_env_in_payload(task, source_env_prefix + "_BASE_REF"))
