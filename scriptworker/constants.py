...
DEFAULT_CONFIG = frozendict({
    ...
    "scriptworker_worker_pools": (
        ...
        "scriptworker-k8s/appservices-3-beetmover",
        "scriptworker-k8s/appservices-3-signing",
        "scriptworker-k8s/appservices-t-signing",
        "scriptworker-k8s/comm-1-balrog",
        "scriptworker-k8s/comm-1-shipit",
        "scriptworker-k8s/comm-3-balrog",
        "scriptworker-k8s/comm-3-beetmover",
        "scriptworker-k8s/comm-3-bouncer",
        "scriptworker-k8s/comm-3-shipit",
        "scriptworker-k8s/comm-3-signing",
        "scriptworker-k8s/comm-3-tree",
        "scriptworker-k8s/comm-t-signing",
        "scriptworker-k8s/gecko-1-addon-dev",
        "scriptworker-k8s/gecko-1-balrog",
        "scriptworker-k8s/gecko-1-balrog-dev",
        "scriptworker-k8s/gecko-1-beetmover",
        "scriptworker-k8s/gecko-1-beetmover-dev",
        "scriptworker-k8s/gecko-1-bouncer",
        "scriptworker-k8s/gecko-1-bouncer-dev",
        "scriptworker-k8s/gecko-1-pushapk",
        "scriptworker-k8s/gecko-1-pushapk-dev",
        "scriptworker-k8s/gecko-1-pushsnap",
        ...
        "scriptworker-k8s/gecko-3-pushsnap",
        "scriptworker-k8s/gecko-3-shipit",
        "scriptworker-k8s/gecko-3-signing",
        "scriptworker-k8s/gecko-3-tree",
        "scriptworker-k8s/gecko-t-signing",
        "scriptworker-k8s/gecko-t-signing-dev",
        "scriptworker-k8s/mobile-1-beetmover",
        "scriptworker-k8s/mobile-1-pushapk",
        "scriptworker-k8s/mobile-3-beetmover",
        "scriptworker-k8s/mobile-3-pushapk",
        "scriptworker-k8s/mobile-3-signing",
